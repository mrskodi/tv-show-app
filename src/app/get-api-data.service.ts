    ...
    for(let i=0; i<len; i++)  
      {
        arrayOfPrograms.push({
          ...
          telecastTime: dataList[i].show.network!=null ? dataList[i].show.schedule.time : 'Anytime',
          ...
          telecastedOn: dataList[i].show.network!=null ? dataList[i].show.network.name : dataList[i].show.webChannel.name,
